...
export default function Profile() {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.NEXT_PUBLIC_GET_RECRUITER_DETAILS}/${recruiterId}`)
      .then((response) => {
  ...
  useEffect(() => {
  }, [companyName, email, description, services]);

  function updateCompanyInfo() {
    axios.patch(
      `${process.env.NEXT_PUBLIC_UPDATE_COMPANY_INFO}/${recruiterId}`,
      companyInfo,
      {
